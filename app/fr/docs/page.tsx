...
import Logo from "@/components/fr/logo"
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <section className="mb-12">
          ...
          <p className="text-white text-lg leading-relaxed mb-6">
            L'interface en ligne de commande officielle pour UploadThing. Simplifiez vos flux de travail de téléchargement de fichiers,
            gérez vos projets UploadThing et déployez en toute confiance avec notre puissant outil CLI.
          </p>
          <div className="bg-purple-400/10 border border-purple-400/20 rounded-lg p-4">
            <div className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-purple-400 mt-0.5 flex-shrink-0" />
              <div>
                <p className="text-white font-medium">Démarrage rapide</p>
                <p className="text-gray-400 text-sm">
                  Soyez opérationnel en quelques secondes avec notre processus d'installation simplifié.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-lg font-semibold text-white mb-3">Installation du projet</h3>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4 mt-5">
            <div>
              <h3 className="text-lg font-semibold text-white mb-3">Configurez votre clé secrète UploadThing</h3>
              <div className="bg-black/40 border border-purple-400/20 rounded-lg p-4 space-y-2">
                <div>
                  <code className="text-gray-400 font-mono">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-lg font-semibold text-white mb-3">Téléversement de fichiers</h3>
              <div className="bg-black/40 border border-purple-400/20 rounded-lg p-4 space-y-2">
                <div>
                  <code className="text-gray-400 font-mono">
                    # Basic upload<br/>
          ...
          <div className="space-y-4 mt-5">
            <div>
              <h3 className="text-lg font-semibold text-white mb-3">Téléchargement de fichiers</h3>
              <div className="bg-black/40 border border-purple-400/20 rounded-lg p-4 space-y-2">
                <div>
                  <code className="text-gray-400 font-mono">
          ...
          <div className="space-y-4 mt-5">
            <div>
              <h3 className="text-lg font-semibold text-white mb-3">Lister les fichiers</h3>
              <div className="bg-black/40 border border-purple-400/20 rounded-lg p-4 space-y-2">
                <div>
                  <code className="text-gray-400 font-mono">
                    # List all files<br/>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-lg font-semibold text-white mb-3">Options de `ut fetch`</h3>
              <div className="bg-black/40 border border-purple-400/20 rounded-lg p-4 space-y-2">
                <div>
                  <code className="text-gray-400 font-mono">
          ...
          <div className="space-y-4 mt-5">
            <div>
              <h3 className="text-lg font-semibold text-white mb-3">Options de `ut list`</h3>
              <div className="bg-black/40 border border-purple-400/20 rounded-lg p-4 space-y-2">
                <div>
                  <code className="text-gray-400 font-mono">
