      ...
      <div className={"h-full flex flex-col"}>
        ...
        <div className="flex-1 flex flex-col justify-end pb-60 pl-40">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href={t("to")} className="flex items-center gap-1 text-purple-400 hover:text-purple-500 transition-colors mt-5 group">
              {t('documentation')} <span className="group-hover:translate-x-1 transition-transform">→</span>
            </a>
          </div>
        </div>
      </div>
